...
<body>
	...
	<pre>
		...
		- 기본 작성법 : \${key} (백슬래시 제거하고 사용)
	</pre>
	
	<h3>전달 받은 파라미터를 출력하는 방법</h3>
	
	<p style="color : red;">
		주소 뒤에 쿼리스티링(?name=홍길동&age=20) 직접 작성하면서 테스트
	</p>
	...
	<h4>2. EL</h4>
	<%--
		EL 특징 : 1. null, NullpointerException을 빈칸으로 처리
				  2. get 이라는 단어 사용하지 않음
	 --%>
	<div>
		name : ${param.name}
		<br>
	...
	<pre>
		JSP에서 자주 사용하는 Java 코드를(if, for, 변수 선언..) 
